    ...
    @if($info['user_type']==1)
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    @if($user['baccarat']==1)
                        <input type="number" name="bjlbets_fee[playerPair]" readonly style="border: 1px solid #DDD;background-color: #F5F5F5;color: #ACA899;" lay-verify="bplayerPair" placeholder="" data-v="{{$user['bjlbets_fee']['playerPair']/100}}" value="{{$info['bjlbets_fee']['playerPair']/100}}"  autocomplete="off" class="layui-input">
                    @else
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    @if($user['baccarat']==1)
                        <input type="number" name="bjlbets_fee[tie]" lay-verify="btie" readonly style="border: 1px solid #DDD;background-color: #F5F5F5;color: #ACA899;" placeholder="" data-v="{{$user['bjlbets_fee']['tie']/100}}" value="{{$info['bjlbets_fee']['tie']/100}}"  autocomplete="off" class="layui-input">
                    @else
                ...
                <div class="layui-input-inline" style="width: 100px;">
                    @if($user['baccarat']==1)
                        <input type="number" name="bjlbets_fee[bankerPair]" readonly style="border: 1px solid #DDD;background-color: #F5F5F5;color: #ACA899;" lay-verify="bbankerPair" placeholder="" data-v="{{$user['bjlbets_fee']['bankerPair']/100}}" value="{{$info['bjlbets_fee']['bankerPair']/100}}"  autocomplete="off" class="layui-input">
                    @else
