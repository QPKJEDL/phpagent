...
@section('header')
    ...
    <button class="layui-btn layui-btn-small layui-btn-normal addBtn" data-desc="添加权限" data-url="{{url('/admin/roles/0/edit')}}"><i class="layui-icon">&#xe654;</i></button>
            ...
            <tr>
                ...
                <td>
                    <div class="layui-inline">
                        ...
                        <button class="layui-btn layui-btn-small layui-btn-danger del-btn" data-id="{{$info['id']}}" data-url="{{url('/admin/roles/'.$info['id'])}}"><i class="layui-icon">&#xe640;</i></button>
                    </div>
                </td>
            </tr>
        @endforeach
